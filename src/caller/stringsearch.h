...
public:
    ...
    void buildHashTable();
    std::vector<StringSearch::Score> searchStartToEnd(std::string *seq);
    std::vector<StringSearch::Score> searchEndToStart(std::string *seq);
    std::vector<int> findMap(std::string seq);
    std::string getStringRange(std::string *seq, int32_t pos, int32_t range);
    std::vector<Score> runNext(std::string *seq, int32_t pos, int32_t posseq);
    std::vector<Score> runBack(std::string *seq, int32_t pos, int32_t posseq);
